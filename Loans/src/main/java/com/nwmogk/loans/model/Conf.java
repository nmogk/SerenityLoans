...
public class Conf {
	...
	private Properties simulationSettings = new Properties();
	
	public Conf(String configurationFile) throws FileNotFoundException, IOException {
		simulationSettings.load( new FileInputStream(configurationFile) );
